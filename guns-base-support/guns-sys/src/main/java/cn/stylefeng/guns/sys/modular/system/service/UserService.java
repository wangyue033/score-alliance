...
public class UserService extends ServiceImpl<UserMapper, User> {
    ...
    public List<User> selectUsersWithList(DataScope dataScope, String s, String beginTime, String endTime, Long deptId) {
        Page page = LayuiPageFactory.defaultPage();
        return baseMapper.selectUsersWithList(page, dataScope, s, beginTime, endTime, deptId);
    }
}
